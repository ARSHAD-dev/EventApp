...
public class Amtc_members extends AppCompatActivity {
     public static final String TAG="Amtc_members";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "Amtcmembers: "+bundle);
        if (bundle != null) {
            Value = bundle.getInt("value");
            Log.i(TAG, "Amtcvalue " +Value);
        }
        ...
        switch(Value) {
            case 11:
                MemTitle.setText("AMTC: MEMBERS");
                break;
            case 12:
                MemTitle.setText("ALIAS: MEMBERS");
                break;
            case 21:
                MemTitle.setText("CEZZANE: MEMBERS");
                break;
            case 31:
                MemTitle.setText("DASP: MEMBERS");
                break;
            case 41:
                MemTitle.setText("STROKES: MEMBERS");
                break;
            case 51:
                MemTitle.setText("AZMIE: MEMBERS");
                break;
            case 61:
                MemTitle.setText("ALFAAZ: MEMBERS");
                break;
        }

...
public class AmtcActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(Value){
            ...
            case 31: ClubTitle.setText("DASP");
                ...
                ClubBanner.setImageResource(R.drawable.dasp_banner);
        ...
        details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent It=new Intent(AmtcActivity.this, Amtc_details .class);
        ...
        join.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent JoinIntent=new Intent(AmtcActivity.this,FromAmtc.class);

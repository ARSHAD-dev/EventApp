...
public class FromAmtc extends AppCompatActivity {
    int Value;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_from_amtc);
        ...
        switch (Value) {
            case 11:
                title.setText("AMTC MEMBERSHIP FORM");
                break;
            case 12:
                title.setText("ALIAS MEMBERSHIP FORM");
                break;
            case 21:
                title.setText("CEZZANE MEMBERSHIP FORM");
                edit6.setHint("Classical, Western, Free-Style Dance, etc");
                break;
            case 31:
                title.setText("DASP REGISTRATION FORM");
                edit6.setHint("Vocal,Guitar,Tabla, etc");
                break;
            case 41:
                title.setText("STROKES MEMBERSHIP FORM");
                edit6.setHint("Doodle, portrait, watercolor, etc");
                break;
            case 51:
                title.setText("AZMIE MEMBERSHIP FORM");
                edit6.setHint("plays, etc");
                break;
            case 61:
                title.setText("ALFAAZ MEMBERSHIP FORM");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra(Intent.EXTRA_EMAIL, new String[]{"arshadalam467@gmail.com"});
                ...
                try {
                    ...
                    Toast.makeText(FromAmtc.this, "There is no Email clients", Toast.LENGTH_SHORT).show();
                }
                finish();
